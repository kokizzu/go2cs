...
| **Behavioral tests** | `src/Tests/Behavioral/` (545 test projects = 570 transpiled Go packages incl. 25 nested sub-libraries; 572 registered `.csproj` incl. the `BehavioralTests`/`BehavioralRunner` tooling — re-measured r41, 2026-08-05) | Go + C# | Per-feature Go↔C# equivalence (arrays, channels, defer, generics, interfaces…). |
