...
| [`encoding/binary`](https://github.com/ritchiecarroll/go2cs/tree/master/src/core/encoding/binary) | 140 | 6 | Reflection-driven Read/Write — the bridge's construction/write-back surface. · linux: 140 + 6 · [proof](validation/current/encoding.binary.md) |
