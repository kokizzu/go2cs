...
[`src/core/go/build`](https://github.com/ritchiecarroll/go2cs/tree/nuget-1.24.13.2/src/core/go/build).
...
hand-owned [`go2cs_test_disclosures.json`](https://github.com/ritchiecarroll/go2cs/blob/nuget-1.24.13.2/src/core/go/build/go2cs_test_disclosures.json);
