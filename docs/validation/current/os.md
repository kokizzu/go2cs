...
**1103 matched · 2 disclosed** — Go 1.24.13, `windows/amd64`, converted package
[`src/core/os`](https://github.com/ritchiecarroll/go2cs/tree/master/src/core/os).

Measured at `Release` (tiered JIT off), oracle `go version go1.24.13 windows/amd64`.

Both runtimes skip 43 of the matched tests identically.
...
| `TestOpenFileCreateExclDanglingSymlink` | skip | skip |
...
| `TestReadlink/symlink_dir_drive_absolute` | skip | skip |
| `TestReadlink/symlink_dir_volume_absolute` | skip | skip |
| `TestReadlink/symlink_dir_volume_relative` | skip | skip |
| `TestReadlink/symlink_file_drive_absolute` | skip | skip |
| `TestReadlink/symlink_file_volume_absolute` | skip | skip |
| `TestReadlink/symlink_file_volume_relative` | skip | skip |
...
| `TestRootConsistencyCreate` | fail | fail |
...
| `TestRootConsistencyCreate/dotdot_in_path_after_symlink` | fail | fail |
...
| `TestRootConsistencyCreate/file_symlink_slash` | fail | fail |
...
| `TestRootConsistencyCreate/resolved_symlink` | fail | fail |
| `TestRootConsistencyCreate/symlink_slash` | fail | fail |
| `TestRootConsistencyCreate/symlink_slash_dot` | fail | fail |
...
| `TestRootConsistencyCreate/unresolved_symlink` | fail | fail |
| `TestRootConsistencyLstat` | fail | fail |
...
| `TestRootConsistencyLstat/dotdot_in_path_after_symlink` | fail | fail |
...
| `TestRootConsistencyLstat/file_symlink_slash` | fail | fail |
...
| `TestRootConsistencyLstat/resolved_symlink` | fail | fail |
| `TestRootConsistencyLstat/symlink_slash` | fail | fail |
| `TestRootConsistencyLstat/symlink_slash_dot` | fail | fail |
...
| `TestRootConsistencyLstat/unresolved_symlink` | fail | fail |
| `TestRootConsistencyMkdir` | fail | fail |
...
| `TestRootConsistencyMkdir/dotdot_in_path_after_symlink` | fail | fail |
...
| `TestRootConsistencyMkdir/file_symlink_slash` | fail | fail |
...
| `TestRootConsistencyMkdir/resolved_symlink` | fail | fail |
| `TestRootConsistencyMkdir/symlink_slash` | fail | fail |
| `TestRootConsistencyMkdir/symlink_slash_dot` | fail | fail |
...
| `TestRootConsistencyMkdir/unresolved_symlink` | fail | fail |
| `TestRootConsistencyOpen` | fail | fail |
...
| `TestRootConsistencyOpen/dotdot_in_path_after_symlink` | fail | fail |
...
| `TestRootConsistencyOpen/file_symlink_slash` | fail | fail |
...
| `TestRootConsistencyOpen/resolved_symlink` | fail | fail |
| `TestRootConsistencyOpen/symlink_slash` | fail | fail |
| `TestRootConsistencyOpen/symlink_slash_dot` | fail | fail |
...
| `TestRootConsistencyOpen/unresolved_symlink` | fail | fail |
| `TestRootConsistencyRemove` | fail | fail |
...
| `TestRootConsistencyRemove/dotdot_in_path_after_symlink` | fail | fail |
...
| `TestRootConsistencyRemove/file_symlink_slash` | fail | fail |
...
| `TestRootConsistencyRemove/resolved_symlink` | fail | fail |
| `TestRootConsistencyRemove/symlink_slash` | fail | fail |
| `TestRootConsistencyRemove/symlink_slash_dot` | fail | fail |
...
| `TestRootConsistencyRemove/unresolved_symlink` | fail | fail |
| `TestRootConsistencyStat` | fail | fail |
...
| `TestRootConsistencyStat/dotdot_in_path_after_symlink` | fail | fail |
...
| `TestRootConsistencyStat/file_symlink_slash` | fail | fail |
...
| `TestRootConsistencyStat/resolved_symlink` | fail | fail |
| `TestRootConsistencyStat/symlink_slash` | fail | fail |
| `TestRootConsistencyStat/symlink_slash_dot` | fail | fail |
...
| `TestRootConsistencyStat/unresolved_symlink` | fail | fail |
| `TestRootCreate` | fail | fail |
| `TestRootCreate/absolute_symlink` | fail | fail |
| `TestRootCreate/directory_does_not_exist` | pass | pass |
| `TestRootCreate/dotdot_after_symlink` | fail | fail |
| `TestRootCreate/dotdot_before_symlink` | fail | fail |
...
| `TestRootCreate/relative_symlink` | fail | fail |
| `TestRootCreate/symlink` | fail | fail |
| `TestRootCreate/symlink_chain` | fail | fail |
| `TestRootCreate/symlink_chain_escapes` | fail | fail |
| `TestRootCreate/symlink_cycle` | fail | fail |
| `TestRootCreate/symlink_dotdot_dotdot_slash` | fail | fail |
| `TestRootCreate/symlink_dotdot_slash` | fail | fail |
| `TestRootCreate/symlink_ending_in_slash` | fail | fail |
| `TestRootCreate/symlink_ends_in_dot` | fail | fail |
| `TestRootDirAsTemp` | pass | pass |
| `TestRootDirFS` | pass | pass |
| `TestRootLstat` | fail | fail |
| `TestRootLstat/absolute_symlink` | fail | fail |
| `TestRootLstat/directory_does_not_exist` | pass | pass |
| `TestRootLstat/dotdot_after_symlink` | fail | fail |
| `TestRootLstat/dotdot_before_symlink` | fail | fail |
...
| `TestRootLstat/relative_symlink` | fail | fail |
| `TestRootLstat/symlink` | fail | fail |
| `TestRootLstat/symlink_chain` | fail | fail |
| `TestRootLstat/symlink_chain_escapes` | fail | fail |
| `TestRootLstat/symlink_cycle` | fail | fail |
| `TestRootLstat/symlink_dotdot_dotdot_slash` | fail | fail |
| `TestRootLstat/symlink_dotdot_slash` | fail | fail |
| `TestRootLstat/symlink_ending_in_slash` | fail | fail |
| `TestRootLstat/symlink_ends_in_dot` | fail | fail |
| `TestRootMkdir` | fail | fail |
| `TestRootMkdir/absolute_symlink` | fail | fail |
| `TestRootMkdir/directory_does_not_exist` | pass | pass |
| `TestRootMkdir/dotdot_after_symlink` | fail | fail |
| `TestRootMkdir/dotdot_before_symlink` | fail | fail |
...
| `TestRootMkdir/relative_symlink` | fail | fail |
| `TestRootMkdir/symlink` | fail | fail |
| `TestRootMkdir/symlink_chain` | fail | fail |
| `TestRootMkdir/symlink_chain_escapes` | fail | fail |
| `TestRootMkdir/symlink_cycle` | fail | fail |
| `TestRootMkdir/symlink_dotdot_dotdot_slash` | fail | fail |
| `TestRootMkdir/symlink_dotdot_slash` | fail | fail |
| `TestRootMkdir/symlink_ending_in_slash` | fail | fail |
| `TestRootMkdir/symlink_ends_in_dot` | fail | fail |
| `TestRootName` | pass | pass |
| `TestRootNonPermissionMode` | pass | pass |
| `TestRootOpenFileAsRoot` | pass | pass |
| `TestRootOpenRoot` | fail | fail |
| `TestRootOpenRoot/absolute_symlink` | fail | fail |
| `TestRootOpenRoot/directory_does_not_exist` | pass | pass |
| `TestRootOpenRoot/dotdot_after_symlink` | fail | fail |
| `TestRootOpenRoot/dotdot_before_symlink` | fail | fail |
...
| `TestRootOpenRoot/relative_symlink` | fail | fail |
| `TestRootOpenRoot/symlink` | fail | fail |
| `TestRootOpenRoot/symlink_chain` | fail | fail |
| `TestRootOpenRoot/symlink_chain_escapes` | fail | fail |
| `TestRootOpenRoot/symlink_cycle` | fail | fail |
| `TestRootOpenRoot/symlink_dotdot_dotdot_slash` | fail | fail |
| `TestRootOpenRoot/symlink_dotdot_slash` | fail | fail |
| `TestRootOpenRoot/symlink_ending_in_slash` | fail | fail |
| `TestRootOpenRoot/symlink_ends_in_dot` | fail | fail |
| `TestRootOpen_Directory` | fail | fail |
| `TestRootOpen_Directory/absolute_symlink` | fail | fail |
| `TestRootOpen_Directory/directory_does_not_exist` | pass | pass |
| `TestRootOpen_Directory/dotdot_after_symlink` | fail | fail |
| `TestRootOpen_Directory/dotdot_before_symlink` | fail | fail |
...
| `TestRootOpen_Directory/relative_symlink` | fail | fail |
| `TestRootOpen_Directory/symlink` | fail | fail |
| `TestRootOpen_Directory/symlink_chain` | fail | fail |
| `TestRootOpen_Directory/symlink_chain_escapes` | fail | fail |
| `TestRootOpen_Directory/symlink_cycle` | fail | fail |
| `TestRootOpen_Directory/symlink_dotdot_dotdot_slash` | fail | fail |
| `TestRootOpen_Directory/symlink_dotdot_slash` | fail | fail |
| `TestRootOpen_Directory/symlink_ending_in_slash` | fail | fail |
| `TestRootOpen_Directory/symlink_ends_in_dot` | fail | fail |
| `TestRootOpen_File` | fail | fail |
| `TestRootOpen_File/absolute_symlink` | fail | fail |
| `TestRootOpen_File/directory_does_not_exist` | pass | pass |
| `TestRootOpen_File/dotdot_after_symlink` | fail | fail |
| `TestRootOpen_File/dotdot_before_symlink` | fail | fail |
...
| `TestRootOpen_File/relative_symlink` | fail | fail |
| `TestRootOpen_File/symlink` | fail | fail |
| `TestRootOpen_File/symlink_chain` | fail | fail |
| `TestRootOpen_File/symlink_chain_escapes` | fail | fail |
| `TestRootOpen_File/symlink_cycle` | fail | fail |
| `TestRootOpen_File/symlink_dotdot_dotdot_slash` | fail | fail |
| `TestRootOpen_File/symlink_dotdot_slash` | fail | fail |
| `TestRootOpen_File/symlink_ending_in_slash` | fail | fail |
| `TestRootOpen_File/symlink_ends_in_dot` | fail | fail |
| `TestRootRaceRenameDir` | pass | pass |
| `TestRootRelativeDirSymlink` | skip | skip |
| `TestRootRemoveDirectory` | fail | fail |
| `TestRootRemoveDirectory/absolute_symlink` | fail | fail |
| `TestRootRemoveDirectory/directory_does_not_exist` | pass | pass |
| `TestRootRemoveDirectory/dotdot_after_symlink` | fail | fail |
| `TestRootRemoveDirectory/dotdot_before_symlink` | fail | fail |
...
| `TestRootRemoveDirectory/relative_symlink` | fail | fail |
| `TestRootRemoveDirectory/symlink` | fail | fail |
| `TestRootRemoveDirectory/symlink_chain` | fail | fail |
| `TestRootRemoveDirectory/symlink_chain_escapes` | fail | fail |
| `TestRootRemoveDirectory/symlink_cycle` | fail | fail |
| `TestRootRemoveDirectory/symlink_dotdot_dotdot_slash` | fail | fail |
| `TestRootRemoveDirectory/symlink_dotdot_slash` | fail | fail |
| `TestRootRemoveDirectory/symlink_ending_in_slash` | fail | fail |
| `TestRootRemoveDirectory/symlink_ends_in_dot` | fail | fail |
| `TestRootRemoveFile` | fail | fail |
| `TestRootRemoveFile/absolute_symlink` | fail | fail |
| `TestRootRemoveFile/directory_does_not_exist` | pass | pass |
| `TestRootRemoveFile/dotdot_after_symlink` | fail | fail |
| `TestRootRemoveFile/dotdot_before_symlink` | fail | fail |
...
| `TestRootRemoveFile/relative_symlink` | fail | fail |
| `TestRootRemoveFile/symlink` | fail | fail |
| `TestRootRemoveFile/symlink_chain` | fail | fail |
| `TestRootRemoveFile/symlink_chain_escapes` | fail | fail |
| `TestRootRemoveFile/symlink_cycle` | fail | fail |
| `TestRootRemoveFile/symlink_dotdot_dotdot_slash` | fail | fail |
| `TestRootRemoveFile/symlink_dotdot_slash` | fail | fail |
| `TestRootRemoveFile/symlink_ending_in_slash` | fail | fail |
| `TestRootRemoveFile/symlink_ends_in_dot` | fail | fail |
| `TestRootRenameAfterOpen` | skip | skip |
| `TestRootStat` | fail | fail |
| `TestRootStat/absolute_symlink` | fail | fail |
| `TestRootStat/directory_does_not_exist` | pass | pass |
| `TestRootStat/dotdot_after_symlink` | fail | fail |
| `TestRootStat/dotdot_before_symlink` | fail | fail |
...
| `TestRootStat/relative_symlink` | fail | fail |
| `TestRootStat/symlink` | fail | fail |
| `TestRootStat/symlink_chain` | fail | fail |
| `TestRootStat/symlink_chain_escapes` | fail | fail |
| `TestRootStat/symlink_cycle` | fail | fail |
| `TestRootStat/symlink_dotdot_dotdot_slash` | fail | fail |
| `TestRootStat/symlink_dotdot_slash` | fail | fail |
| `TestRootStat/symlink_ending_in_slash` | fail | fail |
| `TestRootStat/symlink_ends_in_dot` | fail | fail |
| `TestRootSymlinkToRoot` | fail | fail |
...
| `TestShareNotExistError` | fail | fail |
