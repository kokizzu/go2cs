...
[`src/core/go/build`](https://github.com/ritchiecarroll/go2cs/tree/nuget-1.23.12.3/src/core/go/build).
...
hand-owned [`go2cs_test_disclosures.json`](https://github.com/ritchiecarroll/go2cs/blob/nuget-1.23.12.3/src/core/go/build/go2cs_test_disclosures.json);
