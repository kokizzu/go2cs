...
internal static void Updatef(this ж<chattyPrinter> Ꮡp, @string testName, @string format, params ꓸꓸꓸany argsʗp) => func(ref argsʗp, (ref ꓸꓸꓸany argsʗp, Defer defer, Recover recover) => {
...
internal static void Printf(this ж<chattyPrinter> Ꮡp, @string testName, @string format, params ꓸꓸꓸany argsʗp) => func(ref argsʗp, (ref ꓸꓸꓸany argsʗp, Defer defer, Recover recover) => {
    var args = argsʗp.slice();
...
internal static void flushToParent(this ж<common> Ꮡc, @string testName, @string format, params ꓸꓸꓸany argsʗp) => func(ref argsʗp, (ref ꓸꓸꓸany argsʗp, Defer defer, Recover recover) => {
    var args = argsʗp.slice();
...
internal static TB _ᴛ2ʗ = new TжTB(((ж<T>)nil));

internal static TB _ᴛ3ʗ = new BжTB(((ж<B>)nil));
...
internal static @string TempDir(this ж<common> Ꮡc) {
    ...
    @string dir = fmt.Sprintf("%s%c%03d"u8, c.tempDir, (int32)(os.PathSeparator), seq);
    {
...
internal static ж<testContext> newTestContext(nint maxParallel, ж<matcher> Ꮡm) {
    return Ꮡ(new testContext(
        match: Ꮡm,
        startParallel: new channel<bool>(0),
