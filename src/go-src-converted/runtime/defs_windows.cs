...
internal static readonly UntypedInt _DUPLICATE_SAME_ACCESS = 0x2;
internal static readonly UntypedInt _THREAD_PRIORITY_HIGHEST = 0x2;
internal static readonly UntypedInt _SIGINT = 0x2;
internal static readonly UntypedInt _SIGTERM = 0xF;
internal static readonly UntypedInt _CTRL_C_EVENT = 0x0;
internal static readonly UntypedInt _CTRL_BREAK_EVENT = 0x1;
internal static readonly UntypedInt _CTRL_CLOSE_EVENT = 0x2;
internal static readonly UntypedInt _CTRL_LOGOFF_EVENT = 0x5;
internal static readonly UntypedInt _CTRL_SHUTDOWN_EVENT = 0x6;
internal static readonly UntypedInt _EXCEPTION_ACCESS_VIOLATION = 0xc0000005;
internal static readonly UntypedInt _EXCEPTION_IN_PAGE_ERROR = 0xc0000006;
internal static readonly UntypedInt _EXCEPTION_BREAKPOINT = 0x80000003;
internal static readonly UntypedInt _EXCEPTION_ILLEGAL_INSTRUCTION = 0xc000001d;
internal static readonly UntypedInt _EXCEPTION_FLT_DENORMAL_OPERAND = 0xc000008d;
internal static readonly UntypedInt _EXCEPTION_FLT_DIVIDE_BY_ZERO = 0xc000008e;
internal static readonly UntypedInt _EXCEPTION_FLT_INEXACT_RESULT = 0xc000008f;
internal static readonly UntypedInt _EXCEPTION_FLT_OVERFLOW = 0xc0000091;
internal static readonly UntypedInt _EXCEPTION_FLT_UNDERFLOW = 0xc0000093;
internal static readonly UntypedInt _EXCEPTION_INT_DIVIDE_BY_ZERO = 0xc0000094;
internal static readonly UntypedInt _EXCEPTION_INT_OVERFLOW = 0xc0000095;
internal static readonly UntypedInt _INFINITE = 0xffffffff;
internal static readonly UntypedInt _WAIT_TIMEOUT = 0x102;
internal static readonly UntypedInt _EXCEPTION_CONTINUE_EXECUTION = /* -0x1 */ -1;
internal static readonly UntypedInt _EXCEPTION_CONTINUE_SEARCH = 0x0;
internal static readonly UntypedInt _EXCEPTION_CONTINUE_SEARCH_SEH = 0x1;
