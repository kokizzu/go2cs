...
using static go.go.token_test_package;
...
// <ImplicitConversions>
[assembly: GoImplicitConv<FileSet, ж<FileSet>>(Indirect = true)]
[assembly: GoImplicitConv<ΔFile, ж<ΔFile>>(Indirect = true)]
// </ImplicitConversions>
...
public static partial class token_package
{
    ...
    public partial struct TestFileAddLineColumnInfo_tests {}
    public partial struct TestIsIdentifier_tests {}
