...
private static readonly @string negativePrefixBitsˢ = "negative Prefix bits"u8;
...
// Hoisted @string literals (single allocation; Go keeps these in RODATA)
private static readonly @string invalidIpˢ = "invalid IP"u8;
...
// Hoisted @string literals (single allocation; Go keeps these in RODATA)
private static readonly @string unexpectedSliceSizeˢ = "unexpected slice size"u8;
...
// Hoisted @string literals (single allocation; Go keeps these in RODATA)
private static readonly @string notAnIpPortˢ = "not an ip:port"u8;
private static readonly @string noIpˢ = "no IP"u8;
private static readonly @string noPortˢ = "no port"u8;
...
// Hoisted @string literals (single allocation; Go keeps these in RODATA)
private static readonly @string invalidAddrPortˢ = "invalid AddrPort"u8;
...
// Hoisted @string literals (single allocation; Go keeps these in RODATA)
private static readonly @string invalidPrefixˢ = "invalid Prefix"u8;
