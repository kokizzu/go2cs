...
[assembly: GoImplement<AddrError, temporary>(Pointer = true)]
[assembly: GoImplement<AddrError, timeout>(Pointer = true)]
...
[assembly: GoImplement<DNSConfigError, temporary>(Pointer = true)]
[assembly: GoImplement<DNSConfigError, timeout>(Pointer = true)]
[assembly: GoImplement<DNSConfigError, ΔError>(Pointer = true)]
[assembly: GoImplement<DNSError, error>(Pointer = true)]
[assembly: GoImplement<DNSError, temporary>(Pointer = true)]
[assembly: GoImplement<DNSError, timeout>(Pointer = true)]
...
[assembly: GoImplement<IPConn, buffersWriter>(Pointer = true)]
[assembly: GoImplement<IPNet, ΔAddr>(Pointer = true)]
[assembly: GoImplement<InvalidAddrError, temporary>]
[assembly: GoImplement<InvalidAddrError, timeout>]
[assembly: GoImplement<InvalidAddrError, ΔError>]
[assembly: GoImplement<OpError, error>(Pointer = true)]
[assembly: GoImplement<OpError, temporary>(Pointer = true)]
[assembly: GoImplement<OpError, timeout>(Pointer = true)]
[assembly: GoImplement<OpError, ΔError>(Pointer = true)]
[assembly: GoImplement<ParseError, error>(Pointer = true)]
[assembly: GoImplement<ParseError, temporary>(Pointer = true)]
[assembly: GoImplement<ParseError, timeout>(Pointer = true)]
...
[assembly: GoImplement<TCPConn, buffersWriter>(Pointer = true)]
...
[assembly: GoImplement<UDPConn, buffersWriter>(Pointer = true)]
...
[assembly: GoImplement<UnixConn, buffersWriter>(Pointer = true)]
[assembly: GoImplement<UnixListener, Listener>(Pointer = true)]
[assembly: GoImplement<UnknownNetworkError, temporary>]
[assembly: GoImplement<UnknownNetworkError, timeout>]
...
[assembly: GoImplement<conn, buffersWriter>(Pointer = true)]
...
[assembly: GoImplement<go.@internal.poll_package.errNetClosing, temporary>]
[assembly: GoImplement<go.@internal.poll_package.errNetClosing, timeout>]
[assembly: GoImplement<go.@internal.poll_package.errNetClosing, ΔError>]
[assembly: GoImplement<goLookupIPCNAMEOrder_result, error>(Promoted = true)]
[assembly: GoImplement<netFD, buffersWriter>(Pointer = true)]
...
[assembly: GoImplement<syscall_package.Errno, temporary>]
[assembly: GoImplement<syscall_package.Errno, timeout>]
[assembly: GoImplement<syscall_package.Errno, ΔError>]
...
[assembly: GoImplement<temporaryError, temporary>(Pointer = true)]
[assembly: GoImplement<temporaryError, timeout>(Pointer = true)]
[assembly: GoImplement<temporaryError, ΔError>(Pointer = true)]
[assembly: GoImplement<timeoutError, error>(Pointer = true)]
[assembly: GoImplement<timeoutError, temporary>(Pointer = true)]
[assembly: GoImplement<timeoutError, timeout>(Pointer = true)]
[assembly: GoImplement<timeoutError, ΔError>(Pointer = true)]
// </InterfaceImplementations>
