...
internal static void initᴛcompareTests() { compareTests = new slice<reflectꓸValue>[]{
    ...
    ct(reflect.TypeOf((complex64)(0F + 1F.i())), -1D - 1D.i(), -1D + 0D.i(), -1D + 1D.i(), 0D - 1D.i(), 0D + 0D.i(), 0D + 1D.i(), 1D - 1D.i(), 1D + 0D.i(), 1D + 1D.i()),
    ct(reflect.TypeOf((complex128)(0D + 1D.i())), -1D - 1D.i(), -1D + 0D.i(), -1D + 1D.i(), 0D - 1D.i(), 0D + 0D.i(), 0D + 1D.i(), 1D - 1D.i(), 1D + 0D.i(), 1D + 1D.i()),
