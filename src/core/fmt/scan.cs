...
// Newlines in the input must match newlines in the format.
[GoStr] public static (nint n, error err) Sscanf(@string strʗp, sstring format, params ꓸꓸꓸany aʗp) {
    var a = aʗp.sslice();
...
// returns the number of items successfully parsed.
// Newlines in the input must match newlines in the format.
[GoStr] public static (nint n, error err) Fscanf(Δio.Reader r, sstring format, params ꓸꓸꓸany aʗp) {
    nint n = default!;
    error err = default!;
    var a = aʗp.slice();
...
[GoStr] internal static nint indexRune(sstring s, rune r) {
...
[GoStr] [GoRecv] internal static bool consume(this ref ss s, sstring ok, bool accept) {
    var r = s.getRune();
    if (r == eof) {
        return false;
    }
...
[GoStr] [GoRecv] internal static bool peek(this ref ss s, sstring ok) {
    var r = s.getRune();
    if (r != eof) {
        s.UnreadRune();
    }
...
[GoStr] [GoRecv] internal static bool accept(this ref ss s, sstring ok) {
    return s.consume(ok, true);
}

// okVerb verifies that the verb is present in the list, setting s.err appropriately if not.
[GoStr] [GoRecv] internal static bool okVerb(this ref ss s, rune verb, sstring okVerbs, sstring typ) {
...
[GoStr] [GoRecv] internal static @string scanNumber(this ref ss s, sstring digits, bool haveDigits) {
    if (!haveDigits) {
        s.notEOF();
        if (!s.accept(digits)) {
...
[GoStr] internal static bool hasX(sstring s) {
...
[GoStr] [GoRecv] internal static nint /*i*/ advance(this ref ss s, sstring format) {
    nint i = default!;
...
[GoStr] internal static (nint numProcessed, error err) doScanf(this ж<ss> Ꮡs, sstring format, slice<any> a) {
    nint numProcessed = default!;
    heap<error>(out var Ꮡerr);
    GoFrame ᒐ = default;
    try {
