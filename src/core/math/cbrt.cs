...
[assembly: go.GoPositionMap("math/cbrt.go", "cbrt.cs", "AAk0ABMCgpSmggAIFpSmgoKCqIKUgoKogoKWloKCgoKWgpQ=")]
...
internal static float64 cbrt(float64 x) {
    ...
    t = Float64frombits((uint64)(Float64bits(t) & (((uint64)unchecked((nint)0xFFFFFFFFCL) << (int)(28)))) + ((uint64)1 << (int)(30)));
