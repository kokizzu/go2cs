...
[![Tests](https://img.shields.io/badge/Tests-36%2F36_validated-brightgreen?logo=go)](https://go2cs.net/validation/1.23.1.4/math.rand.v2.html) [![Docs](https://img.shields.io/badge/Docs-@1.23.1-00ADD8?logo=go)](https://pkg.go.dev/math/rand/v2@go1.23.1) [![Source](https://img.shields.io/badge/Source-Go_@1.23.1-00ADD8?logo=go)](https://github.com/golang/go/tree/go1.23.1/src/math/rand/v2) [![Source](https://img.shields.io/badge/Source-C%23_@1.23.1.4-512BD4?logo=dotnet)](https://github.com/ritchiecarroll/go2cs/tree/nuget-1.23.1.4/src/core/math/rand/v2)
...
This package's outputs might be easily predictable regardless of how it's seeded. For random numbers suitable for security-sensitive work, see the [crypto/rand](/crypto/rand) package.
