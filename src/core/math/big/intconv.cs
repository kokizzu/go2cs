...
public static slice<byte> Append(this ж<ΔInt> Ꮡx, slice<byte> buf, nint @base) {
    ...
    return appendꓸꓸꓸ(buf, x.abs.itoa(x.neg, @base));
}

// String returns the decimal representation of x as generated by
// x.Text(10).
public static @string String(this ж<ΔInt> Ꮡx) {
    return Ꮡx.Text(10);
}
...
internal static fmt.Formatter _ᴛ4ʗ = new ΔIntжFormatter(intOne);   // *Int must implement fmt.Formatter
...
// justification.
public static void Format(this ж<ΔInt> Ꮡx, fmt.State s, rune ch) {
    ref var x = ref Ꮡx.DerefOrNull();
    ...
    default: {
        fmt.Fprintf(new fmt_StateᴠWriter(s), // unknown format
 "%%!%c(big.Int=%s)"u8, ch, Ꮡx.String());
        return;
    }}
...
// base is 10.
internal static (ж<ΔInt>, nint, error) scan(this ж<ΔInt> Ꮡz, io.ByteScanner r, nint @base) {
...
internal static (byte, error) ReadByte(this byteReader r) {
    var (ch, size, err) = r.ScanState.ReadRune();
...
public static error Scan(this ж<ΔInt> Ꮡz, fmt.ScanState s, rune ch) {
    ...
    var (_, _, err) = Ꮡz.scan(new byteReader(s), @base);
    return err;
}
