...
[assembly: go.GoPositionMap("math/big/accuracy_string.go", "accuracy_string.cs", "/oaigoLugoKClA==")]
...
[assembly: go.GoPositionMap("math/big/float.go", "float.cs", "")]
[assembly: go.GoPositionMap("math/big/floatconv.go", "floatconv.cs", "AA8s0oCCpK4ACQKCgqiWgoKYkoKCmJKCgoKogoKCgoIADSCClriCpLakpKTcpLakyoKCgoKUgpaUgrqCgpSWACZSwoKCqIKohIKClIKWAAJgADIEgoKUgoKWgoCCuICCpKaqogAEFNKCgg==")]
[assembly: go.GoPositionMap("math/big/floatmarsh.go", "floatmarsh.cs", "ABAq0oKogoKU3IKmlISCgoKUgoSCgpbu4pSClIKWgpaChIKCgoKChIKClIKWgoKWgIKmrLKClIKu1IKClA==")]
[assembly: go.GoPositionMap("math/big/ftoa.go", "ftoa.cs", "")]
[assembly: go.GoPositionMap("math/big/int.go", "int.cs", "")]
...
[assembly: go.GoPositionMap("math/big/nat.go", "nat.cs", "")]
...
[assembly: go.GoPositionMap("math/big/prime.go", "prime.cs", "AAo0ABkUgpSCmJiCgpaCloKEkpSCpIKCpKaElgACENKUgoSChKKEgoKClIKUgoKUgoKCgpSCprYAAjYAGQSCuIIACBSCgoKCgoKmlIKCgpTclLiCgoIADyKCgoIAGzyCgoKCgqaCgoKUgoK4goKClIKCugAHEIKCgpSCgoKCgoK6gpK4kriCgpQ=")]
