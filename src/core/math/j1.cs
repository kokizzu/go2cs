...
[assembly: go.GoPositionMap("math/j1.go", "j1.cs", "AAyWAQBDAgAMHpSkpoKCgpSCgoKWgoKClM6CgpSCgpSClJSSlIKCgoKCgpQABRYACAIADR6UpKSmgoKCloKCgpQADByCgpSCgpSUkpSCgoIAhgGgAYKCgoKCpIKkgqSClIKCggCOAagBgpKCgqSCpIKkgpSCgoI=")]
...
public static float64 J1(float64 x) {
    ...
    const float64 R03 = 4.96727999609584448412e-08; // 0x3E6AAAFA46CA0BD9
    const float64 S01 = 1.91537599538363460805e-02; // 0x3F939D0B12637E53
    const float64 S02 = 1.85946785588630915560e-04; // 0x3F285F56B9CDF664
    const float64 S03 = 1.17718464042623683263e-06; // 0x3EB3BFF8333F8498
    const float64 S04 = 5.04636257076217042715e-09; // 0x3E35AC88C97DFF2C
    const float64 S05 = 1.23542274426137913908e-11; // 0x3DAB2ACFCFB97ED8
    // special cases
    switch (ᐧ) {
    case {} when IsNaN(x): {
        return x;
...
public static float64 Y1(float64 x) {
    ...
    const float64 U03 = 2.35252600561610495928e-05; // 0x3EF8AB038FA6B88E
    const float64 U04 = -9.19099158039878874504e-08; // 0xBE78AC00569105B8
    const float64 V00 = 1.99167318236649903973e-02; // 0x3F94650D3F4DA9F0
    const float64 V01 = 2.02552581025135171496e-04; // 0x3F2A8C896C257764
    const float64 V02 = 1.35608801097516229404e-06; // 0x3EB6C05A894E8CA6
    const float64 V03 = 6.22741452364621501295e-09; // 0x3E3ABF1D5BA69A86
...
internal static ж<array<float64>> Ꮡp1R8 = new(new float64[]{
    ...
    4.12051854307378562225e+02D,
    3.87474538913960532227e+03D,
    7.91447954031891731574e+03D
}.array());
internal static ref array<float64> p1R8 => ref Ꮡp1R8.Value;
...
internal static ж<array<float64>> Ꮡp1S8 = new(new float64[]{
    ...
    9.76027935934950801311e+04D,
    3.08042720627888811578e+04D
}.array());
internal static ref array<float64> p1S8 => ref Ꮡp1S8.Value;
...
internal static ж<array<float64>> Ꮡp1R5 = new(new float64[]{
    ...
    1.08308182990189109773e+02D,
    5.17636139533199752805e+02D,
    5.28715201363337541807e+02D
}.array());
internal static ref array<float64> p1R5 => ref Ꮡp1R5.Value;
...
internal static ж<array<float64>> Ꮡp1S5 = new(new float64[]{
    ...
    7.84469031749551231769e+03D,
    1.50404688810361062679e+03D
}.array());
internal static ref array<float64> p1S5 => ref Ꮡp1S5.Value;
...
internal static ж<array<float64>> Ꮡp1R3 = new(new float64[]{
    ...
    3.51194035591636932736e+01D,
    9.10550110750781271918e+01D,
    4.85590685197364919645e+01D
}.array());
internal static ref array<float64> p1R3 => ref Ꮡp1R3.Value;
...
internal static ж<array<float64>> Ꮡp1S3 = new(new float64[]{
    ...
    8.90811346398256432622e+02D,
    1.03787932439639277504e+02D
}.array());
internal static ref array<float64> p1S3 => ref Ꮡp1S3.Value;
...
internal static ж<array<float64>> Ꮡp1R2 = new(new float64[]{
    ...
    1.22426109148261232917e+01D,
    1.76939711271687727390e+01D,
    5.07352312588818499250e+00D
}.array());
internal static ref array<float64> p1R2 => ref Ꮡp1R2.Value;
...
internal static ж<array<float64>> Ꮡp1S2 = new(new float64[]{
    ...
    1.17679373287147100768e+02D,
    8.36463893371618283368e+00D
}.array());
internal static ref array<float64> p1S2 => ref Ꮡp1S2.Value;
...
internal static ж<array<float64>> Ꮡq1R8 = new(new float64[]{
    ...
    -7.59601722513950107896e+02D,
    -1.18498066702429587167e+04D,
    -4.84385124285750353010e+04D
}.array());
internal static ref array<float64> q1R8 => ref Ꮡq1R8.Value;
...
internal static ж<array<float64>> Ꮡq1S8 = new(new float64[]{
    ...
    7.19657723683240939863e+05D,
    6.66601232617776375264e+05D,
    -2.94490264303834643215e+05D
}.array());
internal static ref array<float64> q1S8 => ref Ꮡq1S8.Value;
...
internal static ж<array<float64>> Ꮡq1R5 = new(new float64[]{
    ...
    -1.83669607474888380239e+02D,
    -1.37319376065508163265e+03D,
    -2.61244440453215656817e+03D
}.array());
internal static ref array<float64> q1R5 => ref Ꮡq1R5.Value;
...
internal static ж<array<float64>> Ꮡq1S5 = new(new float64[]{
    ...
    4.98514270910352279316e+04D,
    2.79480751638918118260e+04D,
    -4.71918354795128470869e+03D
}.array());
internal static ref array<float64> q1S5 => ref Ꮡq1S5.Value;
...
internal static ж<array<float64>> Ꮡq1R3 = new(new float64[]{
    ...
    -5.78472216562783643212e+01D,
    -2.28244540737631695038e+02D,
    -2.19210128478909325622e+02D
}.array());
internal static ref array<float64> q1R3 => ref Ꮡq1R3.Value;
...
internal static ж<array<float64>> Ꮡq1S3 = new(new float64[]{
    ...
    5.54772909720722782367e+03D,
    1.90311919338810798763e+03D,
    -1.35201191444307340817e+02D
}.array());
internal static ref array<float64> q1S3 => ref Ꮡq1S3.Value;
...
internal static ж<array<float64>> Ꮡq1R2 = new(new float64[]{
    ...
    -1.96636162643703720221e+01D,
    -4.23253133372830490089e+01D,
    -2.13719211703704061733e+01D
}.array());
internal static ref array<float64> q1R2 => ref Ꮡq1R2.Value;
...
internal static ж<array<float64>> Ꮡq1S2 = new(new float64[]{
    ...
    7.39393205320467245656e+02D,
    1.55949003336666123687e+02D,
    -4.95949898822628210127e+00D
}.array());
internal static ref array<float64> q1S2 => ref Ꮡq1S2.Value;
