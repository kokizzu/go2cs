...
[assembly: go.GoPositionMap("math/cmplx/asin.go", "asin.cs", "AAtmACkCgKSkpJSkpNaUpKTWtIKCgoKCqJKApKSklKSk1pSkpNa0goIAAiIADgKCqJKClIKClAACSgAiAoCkpKSClKS0goKClIKEgoKClIKCqJKCgg==")]
...
public static complex128 Asin(complex128 x) {
    {
...
public static complex128 Atan(complex128 x) {
    {
        var (re, im) = (real(x), imag(x));
        switch (ᐧ) {
        case {} when im is 0D: {
