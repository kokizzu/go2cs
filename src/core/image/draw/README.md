...
[![Tests](https://img.shields.io/badge/Tests-9%2F9_validated-brightgreen?logo=go)](https://go2cs.net/validation/1.23.1.3/image.draw.html) [![Docs](https://img.shields.io/badge/Docs-@1.23.1-00ADD8?logo=go)](https://pkg.go.dev/image/draw@go1.23.1)
