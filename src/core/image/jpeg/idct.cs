...
[assembly: go.GoPositionMap("image/jpeg/idct.go", "idct.cs", "ADqQAQANBIKClISCgoKCgoKCgoKogoKCgoKCgpaCgoKCgpaCgoKCgoKCgpaCgoKCgpaCgoKCgoKCqLiWgoKCgoKCgpaCgoKCgpaCgoKCgoKCgpaCgoKCgpaCgoKCgoKC")]
...
internal static void idct(ж<block> Ꮡsrc) {
    ...
    for (nint y = 0; y < 8; y++) {
        ...
        var x7 = s[3];
        // Stage 1.
        var x8 = (int32)w7 * (x4 + x5);
        x4 = x8 + (int32)w1mw7 * x4;
        x5 = x8 - (int32)w1pw7 * x5;
        x8 = (int32)w3 * (x6 + x7);
        x6 = x8 - (int32)w3mw5 * x6;
        x7 = x8 - (int32)w3pw5 * x7;
        // Stage 2.
        x8 = x0 + x1;
        x0 -= x1;
        x1 = (int32)w6 * (x3 + x2);
        x2 = x1 - (int32)w2pw6 * x2;
        x3 = x1 + (int32)w2mw6 * x3;
        x1 = x4 + x6;
        x4 -= x6;
        x6 = x5 + x7;
        x5 -= x7;
        ...
        x3 = x0 + x2;
        x0 -= x2;
        x2 = (((int32)r2 * (x4 + x5) + 128) >> (int)(8));
        x4 = (((int32)r2 * (x4 - x5) + 128) >> (int)(8));
        // Stage 4.
        s[0] = ((x7 + x1) >> (int)(8));
        s[1] = ((x3 + x2) >> (int)(8));
        s[2] = ((x0 + x4) >> (int)(8));
    ...
    for (nint x = 0; x < 8; x++) {
        ...
        var y7 = s[8 * 3];
        // Stage 1.
        var y8 = (int32)w7 * (y4 + y5) + 4;
        y4 = ((y8 + (int32)w1mw7 * y4) >> (int)(3));
        y5 = ((y8 - (int32)w1pw7 * y5) >> (int)(3));
        y8 = (int32)w3 * (y6 + y7) + 4;
        y6 = ((y8 - (int32)w3mw5 * y6) >> (int)(3));
        y7 = ((y8 - (int32)w3pw5 * y7) >> (int)(3));
        // Stage 2.
        y8 = y0 + y1;
        y0 -= y1;
        y1 = (int32)w6 * (y3 + y2) + 4;
        y2 = ((y1 - (int32)w2pw6 * y2) >> (int)(3));
        y3 = ((y1 + (int32)w2mw6 * y3) >> (int)(3));
        y1 = y4 + y6;
        y4 -= y6;
        y6 = y5 + y7;
        y5 -= y7;
        ...
        y3 = y0 + y2;
        y0 -= y2;
        y2 = (((int32)r2 * (y4 + y5) + 128) >> (int)(8));
        y4 = (((int32)r2 * (y4 - y5) + 128) >> (int)(8));
        // Stage 4.
        s[8 * 0] = ((y7 + y1) >> (int)(14));
        s[8 * 1] = ((y3 + y2) >> (int)(14));
        s[8 * 2] = ((y0 + y4) >> (int)(14));
