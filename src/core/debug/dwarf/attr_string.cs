...
[assembly: go.GoPositionMap("debug/dwarf/attr_string.go", "attr_string.cs", "AAkOhqKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoKCgoIAgAGCAoKAgqQ=")]
...
internal static readonly @string _Attr_name = ""u8;

internal static map<Attr, @string> _Attr_map = new map<Attr, @string>{
    [1] = _Attr_name[0..7],
    [2] = _Attr_name[7..15],
    [3] = _Attr_name[15..19],
    [9] = _Attr_name[19..27],
...
public static @string String(this Attr i) {
    {
        var (str, ok) = _Attr_map[i, ꟷ]; if (ok) {
            return str;
        }
    }
    return "Attr("u8 + strconv.FormatInt((int64)(uint32)i, 10) + ")"u8;
}
