...
[![Tests](https://img.shields.io/badge/Tests-518%2F518_validated-brightgreen?logo=go)](https://go2cs.net/validation/1.23.12.3/crypto.x509.html) [![Docs](https://img.shields.io/badge/Docs-@1.24.13-00ADD8?logo=go)](https://pkg.go.dev/crypto/x509@go1.24.13)\
