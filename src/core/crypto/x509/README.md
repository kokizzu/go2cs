...
[![Tests](https://img.shields.io/badge/Tests-341%2F341_validated-brightgreen?logo=go)](https://go2cs.net/validation/1.23.12.1/crypto.x509.html) [![Docs](https://img.shields.io/badge/Docs-@1.23.12-00ADD8?logo=go)](https://pkg.go.dev/crypto/x509@go1.23.12)\
