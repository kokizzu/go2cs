...
global using static global::go.crypto.sha1_package;
global using static global::go.crypto.sha1_internal_test_package;
...
using go;
using static global::go.crypto.sha1_test_package;
...
[GoPackage("sha1_test")]
public static partial class sha1_test_package
{
    ...
    [GoInit] internal static void initᴛᴛproduction() {
        builtin.initPackage(typeof(global::go.crypto.sha1_package));
    }
}
