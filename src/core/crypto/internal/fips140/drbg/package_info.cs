...
using go;
using static go.crypto.@internal.fips140.drbg_package;
...
[GoPackage("drbg")]
public static partial class drbg_package
{
    ...
    // <TypeAccessibility>
    public partial interface DefaultReader {}
    ...
    [GoInit] internal static void initᴛᴛimportꓸcryptoꓸinternalꓸentropy() => builtin.initPackage(typeof(go.crypto.@internal.entropy_package));
