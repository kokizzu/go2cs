...
[assembly: go.GoPositionMap("crypto/internal/nistec/fiat/p256_invert.go", "p256_invert.cs", "AAoYABYqgoKEgoKCgoKClIKCgpSCgpSCgoKCgpSCgpSCgpSCgpSCgpSCgpSE")]
...
public static ж<P256Element> Invert(this ж<P256Element> Ꮡe, ж<P256Element> Ꮡx) {
    ...
    //	return    (x47 + i263) << 2 + 1
    //
    ж<P256Element> z = @new<P256Element>().Set(Ꮡe);
