...
using go;
using static go.crypto.tls.@internal.fips140tls_package;
...
[assembly: go.GoPositionMap("crypto/tls/internal/fips140tls/fipstls.go", "fipstls.cs", "ABEegoK8oq7CpoI=")]
// </GoSourcePositionMaps>

namespace go.crypto.tls.@internal;

[GoPackage("fips140tls")]
public static partial class fips140tls_package
{
