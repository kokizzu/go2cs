...
[assembly: go.GoPositionMap("context/example_test.go", "example_test.cs", "ABMqAAoMgoKCkoK0pMiWgpSCgoIAChoACwKCupS0tAAHEgAJBoKUtLQADxLShoCCgqSWgoSCAAIS4qLYggAIFMTKgoKCqMaEgoKCwoSClIKUgtYABRYACgKigpKClIKmgoKUloKCgpSUgoKClJSClIKCAAkQAAkGgoKSlKKCqIKUhIKUgoI=")]
...
public static void ExampleWithCancel() {
    GoFrame ᒐ = default;
    try {
...
public static void ExampleWithDeadline() {
    GoFrame ᒐ = default;
    try {
...
public static void ExampleWithTimeout() {
    GoFrame ᒐ = default;
    try {
...
public static void ExampleAfterFunc_cond() {
    error waitOnCond(context.Context ctx, ж<Δsync.Cond> condΔ1, Func<bool> conditionMet) {
        GoFrame ᒐ = default;
        try {
            var stopf = context.AfterFunc(ctx, () => {
                GoFrame ᒐ = default;
                try {
...
public static void ExampleAfterFunc_connection() {
    GoFrame ᒐ = default;
    try {
...
public static void ExampleAfterFunc_merge() {
    GoFrame ᒐ = default;
    try {
        ...
        defer(cancel1ʗ1, errors.New(ctx1Canceledˢ), ref ᒐ);
