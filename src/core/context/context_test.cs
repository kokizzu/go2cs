...
public static void XTestParentFinishesChild(testingT t) {
    GoFrame ᒐ = default;
    try {
        // Context tree:
        // parent -> cancelChild
...
public static void XTestChildFinishesFirst(testingT t) {
    GoFrame ᒐ = default;
    try {
