...
[![Tests](https://img.shields.io/badge/Tests-89%2F116_validated-brightgreen?logo=go)](https://go2cs.net/validation/1.23.12.1/os.exec.html) [![Docs](https://img.shields.io/badge/Docs-@1.23.12-00ADD8?logo=go)](https://pkg.go.dev/os/exec@go1.23.12)\
