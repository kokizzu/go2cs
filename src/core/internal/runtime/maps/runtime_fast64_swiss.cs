...
internal static @unsafe.Pointer runtime_mapaccess1_fast64(ж<abi.SwissMapType> Ꮡtyp, ж<ΔMap> Ꮡm, uint64 key) {
    ref var typ = ref Ꮡtyp.DerefOrNull();
    ref var m = ref Ꮡm.DerefOrNull();

    if (race.Enabled && Ꮡm != nil) {
        var callerpc = sys.GetCallerPC();
        var pc = abi.FuncPCABIInternal(runtime_mapaccess1_fast64);
    ...
    if (m.dirLen == 0) {
        ...
        while (full != 0) {
            if (key == ~(ж<uint64>)(uintptr)(slotKey) && full.lowestSet()) {
                @unsafe.Pointer slotElem = (@unsafe.Pointer)((uintptr)slotKey + 8);
                return slotElem;
            }
    ...
    ref var k = ref heap<uint64>(out var Ꮡk);
    k = key;
    ...
    for (; ᐧ ; seq = seq.next()) {
        ...
        while (match != 0) {
            ...
            if (key == ~(ж<uint64>)(uintptr)(slotKey)) {
                @unsafe.Pointer slotElem = (@unsafe.Pointer)((uintptr)slotKey + 8);
                return slotElem;
            }
...
internal static (@unsafe.Pointer, bool) runtime_mapaccess2_fast64(ж<abi.SwissMapType> Ꮡtyp, ж<ΔMap> Ꮡm, uint64 key) {
    ref var typ = ref Ꮡtyp.DerefOrNull();
    ref var m = ref Ꮡm.DerefOrNull();

    if (race.Enabled && Ꮡm != nil) {
        var callerpc = sys.GetCallerPC();
        var pc = abi.FuncPCABIInternal(runtime_mapaccess2_fast64);
        race.ReadPC(@unsafe.Pointer.FromPinnedBox(Ꮡm), callerpc, pc);
    }
    if (Ꮡm == nil || m.Used() == 0) {
...
[GoRecv] internal static @unsafe.Pointer putSlotSmallFast64(this ref ΔMap m, ж<abi.SwissMapType> Ꮡtyp, uintptr hash, uint64 key) {
    ...
    while (match != 0) {
        ...
        if (key == ~(ж<uint64>)(uintptr)(slotKeyΔ1)) {
    ...
    var i = match.first();
    @unsafe.Pointer slotKey = (uintptr)g.key(Ꮡtyp, i);
    ((ж<uint64>)(uintptr)(slotKey)).Value = key;
...
internal static @unsafe.Pointer runtime_mapassign_fast64(ж<abi.SwissMapType> Ꮡtyp, ж<ΔMap> Ꮡm, uint64 key) {
    ref var typ = ref Ꮡtyp.DerefOrNull();
    ref var m = ref Ꮡm.DerefOrNull();
    ...
    if (race.Enabled) {
        var callerpc = sys.GetCallerPC();
        var pc = abi.FuncPCABIInternal(runtime_mapassign_fast64);
    ...
    if (m.dirLen == 0) {
        if (m.used < abi.SwissMapGroupSlots) {
            @unsafe.Pointer elem = (uintptr)m.putSlotSmallFast64(Ꮡtyp, hash, key);
            if (m.writing == 0) {
                fatal(concurrentMapWritesˢ);
            }
            m.writing ^= (uint8)(1);
...
[GoRecv] internal static @unsafe.Pointer putSlotSmallFastPtr(this ref ΔMap m, ж<abi.SwissMapType> Ꮡtyp, uintptr hash, @unsafe.Pointer key) {
    ...
    while (match != 0) {
        var iΔ1 = match.first();
        @unsafe.Pointer slotKeyΔ1 = (uintptr)g.key(Ꮡtyp, iΔ1);
        if (key == ~(ж<@unsafe.Pointer>)(uintptr)(slotKeyΔ1)) {
            @unsafe.Pointer slotElemΔ1 = (uintptr)g.elem(Ꮡtyp, iΔ1);
            return slotElemΔ1;
        }
        match = match.removeFirst();
...
internal static @unsafe.Pointer runtime_mapassign_fast64ptr(ж<abi.SwissMapType> Ꮡtyp, ж<ΔMap> Ꮡm, @unsafe.Pointer key) {
    ref var typ = ref Ꮡtyp.DerefOrNull();
    ref var m = ref Ꮡm.DerefOrNull();
    ...
    if (race.Enabled) {
        var callerpc = sys.GetCallerPC();
        var pc = abi.FuncPCABIInternal(runtime_mapassign_fast64ptr);
        race.WritePC(@unsafe.Pointer.FromPinnedBox(Ꮡm), callerpc, pc);
    }
    if (m.writing != 0) {
        fatal(concurrentMapWritesˢ);
...
internal static void runtime_mapdelete_fast64(ж<abi.SwissMapType> Ꮡtyp, ж<ΔMap> Ꮡm, uint64 keyʗp) {
    ref var m = ref Ꮡm.DerefOrNull();

    ref var key = ref heap(keyʗp, out var Ꮡkey);
    if (race.Enabled) {
        var callerpc = sys.GetCallerPC();
        var pc = abi.FuncPCABIInternal(runtime_mapdelete_fast64);
        race.WritePC(@unsafe.Pointer.FromPinnedBox(Ꮡm), callerpc, pc);
    }
    if (Ꮡm == nil || m.Used() == 0) {
        return;
