...
internal static bool supportCopyFileRange() {
...
// which is 0x7ffff000.
internal static UntypedInt maxCopyFileRangeRound => 0x7ffff000;

internal static (bool, error) handleCopyFileRangeErr(error err, int64 copied, int64 written) {
    var exprᴛ1 = err;
