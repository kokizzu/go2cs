...
[assembly: go.GoPositionMap("internal/syscall/windows/syscall_windows.go", "syscall_windows.cs", "ABMqwoKUgoKCgpQA3AHcA6KigoKClIKC7oKUAAoQpoKCgpSCgoKUpqaCgoKUgoKClKYAEiyCgoKUgoKUACdkkgA4hgGygoKCgpSClJSszA==")]
...
[GoType] partial struct ModuleEntry32 {
    ...
    public syscallꓸHandle ModuleHandle;
...
public static ж<syscall.GUID> ᏑWSAID_WSASENDMSG = new(new syscall.GUID(
    ...
    Data2: 0x754f,
    Data3: 0x43ca,
    Data4: new byte[]{0x84, 0xa7, 0x0d, 0xee, 0x44, 0xcf, 0x60, 0x6d}.array()
));
...
public static ж<syscall.GUID> ᏑWSAID_WSARECVMSG = new(new syscall.GUID(
    ...
    Data2: 0x6f1f,
    Data3: 0x436b,
    Data4: new byte[]{0x8a, 0x53, 0xe5, 0x4f, 0xe3, 0x51, 0xc3, 0x22}.array()
));
...
[GoType] partial struct FILE_ID_BOTH_DIR_INFO {
    ...
    public syscall.Filetime ChangeTime;
