...
using go;
using static go.@internal.exportdata_package;
...
[GoPackage("exportdata")]
public static partial class exportdata_package
{
    ...
    [GoInit] internal static void initᴛᴛimportꓸinternalꓸsaferio() => builtin.initPackage(typeof(global::go.@internal.saferio_package));
