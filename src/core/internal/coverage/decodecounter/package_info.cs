...
using go;
using static go.@internal.coverage.decodecounter_package;
...
public static partial class decodecounter_package
{
    ...
    // <TypeAccessibility>
    [GoValueClone("hdr", "ftr")] public partial struct CounterDataReader {}
    public partial struct FuncPayload {}
    // </TypeAccessibility>
