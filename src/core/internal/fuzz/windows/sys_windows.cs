...
[assembly: global::go.GoPositionMap("internal/fuzz/sys_windows.go", "sys_windows.cs", "ABYm4oKCugAMEIKoggAKDoKCloIACxSosriClIKCpqqigoKCgoKCggAICLKCgpSigIKmgoKCgoKUgoKUgoKClIKEpqaokqiS")]
...
[GoRecv] internal static error Close(this ref sharedMem m) {
    ...
    errs = append(errs,
        Δsyscall.UnmapViewOfFile((uintptr)Ꮡ(m.region, 0)),
