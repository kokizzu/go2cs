...
[assembly: go.GoPositionMap("internal/trace/traceviewer/http.go", "http.cs", "ABMegpKAgoIAGuADgoKUAAoWgtaCgoCCgqSCAAyOAoI=")]
...
public static readonly @string CommonStyle = """
...
public static @string URL(this View v, nint rangeIdx) {
    if (rangeIdx < 0) {
        return fmt.Sprintf("/trace?view=%s"u8, v.Type);
    }
...
public static @string URL(this Range r, ViewType viewType) {
...
internal static @string templTrace = """
