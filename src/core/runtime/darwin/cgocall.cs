...
internal static uintptr syscall_cgocaller(@unsafe.Pointer fn, params ꓸꓸꓸuintptr argsʗp) {
    ...
    cgocall(fn, @unsafe.Pointer.FromPinnedBox(Ꮡas));
    return @as.retval;
}
...
internal static int32 cgocall(@unsafe.Pointer fn, @unsafe.Pointer arg) {
    ...
    // of correctness).
    osPreemptExtEnter(ref (mp).DerefOrNull());
    mp.Value.incgo = true;
    ...
    mp.Value.ncgo--;
    osPreemptExtExit(ref (mp).DerefOrNull());
...
internal static void callbackUpdateSystemStack(ref m mp, uintptr sp, bool signal) {
    ...
    if (!signal && _cgo_getstackbound != nil) {
        ...
        asmcgocall(_cgo_getstackbound, @unsafe.Pointer.FromPinnedBox(Ꮡbounds));
...
internal static void cgocallbackg(@unsafe.Pointer fn, @unsafe.Pointer frame, uintptr ctxt) {
    ...
    osPreemptExtExit(ref ((~gp).m).DerefOrNull());
    if ((~gp).nocgocallback) {
    ...
    osPreemptExtEnter(ref ((~gp).m).DerefOrNull());
