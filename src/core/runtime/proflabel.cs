...
[assembly: go.GoPositionMap("runtime/proflabel.go", "proflabel.cs", "AA4qABwmgpQAAhoACgI=")]
...
internal static void runtime_setProfLabel(@unsafe.Pointer labels) {
...
internal static @unsafe.Pointer runtime_getProfLabel() {
    return (~getg()).labels;
}
