...
[![Tests](https://img.shields.io/badge/Tests-not_yet_validated-orange?logo=go)](https://go2cs.net/ValidatedTestPackages.html) [![Docs](https://img.shields.io/badge/Docs-@1.24.13-00ADD8?logo=go)](https://pkg.go.dev/runtime/trace@go1.24.13)\
[![Source](https://img.shields.io/badge/Source-@1.24.13-00ADD8?logo=go)](https://github.com/golang/go/tree/go1.24.13/src/runtime/trace) [![Source](https://img.shields.io/badge/Source-@1.23.12.3-512BD4?logo=dotnet)](https://github.com/ritchiecarroll/go2cs/tree/nuget-1.23.12.3/src/core/runtime/trace)
...
See the [net/http/pprof](https://pkg.go.dev/net/http/pprof@go1.24.13) package for more details about all of the debug endpoints installed by this import.
...
A task is a higher-level component that aids tracing of logical operations such as an RPC request, an HTTP request, or an interesting local operation which may require multiple goroutines working together. Since tasks can involve multiple goroutines, they are tracked via a [context.Context](https://pkg.go.dev/context@go1.24.13#Context) object. \[NewTask] creates a new task and embeds it in the returned [context.Context](https://pkg.go.dev/context@go1.24.13#Context) object. Log messages and regions are attached to the task, if any, in the Context passed to \[Log] and \[WithRegion].
