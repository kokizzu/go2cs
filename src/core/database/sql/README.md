...
[![Tests](https://img.shields.io/badge/Tests-140%2F142_validated-brightgreen?logo=go)](https://go2cs.net/validation/1.23.12.3/database.sql.html) [![Docs](https://img.shields.io/badge/Docs-@1.24.13-00ADD8?logo=go)](https://pkg.go.dev/database/sql@go1.24.13)\
