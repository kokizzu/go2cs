...
[assembly: go.GoPositionMap("encoding/binary/varint.go", "varint.cs", "ACZSooKClKqigoKCgpSCAAIS4oKCgqaUgoKUlIKUqqKCgpSqooKClAACEuKCgoKUAAQSwoKCgoKCgpSUgoKUlIKUrsKCgoKU")]
...
public static UntypedInt MaxVarintLen16 => 3;

public static UntypedInt MaxVarintLen32 => 5;

public static UntypedInt MaxVarintLen64 => 10;

// AppendUvarint appends the varint-encoded form of x,
// as generated by [PutUvarint], to buf and returns the extended buffer.
public static slice<byte> AppendUvarint(slice<byte> buf, uint64 x) {
    while (x >= 0x80) {
        buf = append(buf, (byte)((byte)x | 0x80));
        x >>= (int)(7);
    }
