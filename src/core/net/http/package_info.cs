...
[assembly: go.GoPositionMap("net/http/cookie.go", "cookie.cs", "")]
[assembly: go.GoPositionMap("net/http/filetransport.go", "filetransport.cs", "ABc+AA0CAAIiAA4Cpu6CkoKUpoKCAAoWAA8ggoKUgpSmgoKUhIKUpoKmgoKUhIKmgoKUgoKU")]
...
[assembly: go.GoPositionMap("net/http/header.go", "header.cs", "ABc8wgACENIAAhLiAAIQ0qiSgIKkqqKCrLKokqaCqJKCqIKClIKCgqaClIKClAAJGOKCgoKmAAkUggARKOKCgpSCgoKmgoKssqaigoKUgoKCypSigoKCgIKCtoKmgoKmggACFPCswoKUgpTugIK2gqaAgqSCpqaC")]
[assembly: go.GoPositionMap("net/http/http.go", "http.cs", "AC9cgKigqKKClKaCqJKCgoKmpoKCgoKUpoKUgoKCgoKUgoKmgpQACxaAooCigA==")]
[assembly: go.GoPositionMap("net/http/mapping.go", "mapping.cs", "ABwysoKUgoKClJS+AAkCgpSCgpSCgqaq4oKUgoKCuIKC")]
[assembly: go.GoPositionMap("net/http/pattern.go", "pattern.cs", "")]
...
[assembly: go.GoPositionMap("net/http/routing_index.go", "routing_index.cs", "AB8+ooKUgpSCgoKUAAQcABEOgoKUgoKCprqAgqTKnuKCgoKClIKCgoKAgoKCyIKCgrqClA==")]
[assembly: go.GoPositionMap("net/http/routing_tree.go", "routing_tree.cs", "ACZY1JSUrNKCgpSCgoKUgoKklLyigpSCqsKCgpSUgIKkgoKqwoKUgq7iuICCtqzSgpSAlKSUgILIruKC3IKClKbKgIIACBCCgILagKaClKSuwoKUgoKClKrCgpSCgriCgpSSgIKk")]
[assembly: go.GoPositionMap("net/http/servemux121.go", "servemux121.cs", "ABs+ooKCABAk0oKEgpSClICCpoKUgoKCloLogoKWgqaCgoKokoKUqOa4gIKmuoK4gIKmgoKClqoACAKCloKUgpSClNq0goK6goKmrvKCgoKClIKCrLKEgoCCuIKClIKAgrg=")]
[assembly: go.GoPositionMap("net/http/server.go", "server.cs", "")]
