...
[![Source](https://img.shields.io/badge/Source-@1.23.1-00ADD8?logo=go)](https://github.com/golang/go/tree/go1.23.1/src/net/netip) [![Source](https://img.shields.io/badge/Source-@1.23.1.6-512BD4?logo=dotnet)](https://github.com/ritchiecarroll/go2cs/tree/nuget-1.23.1.6/src/core/net/netip)
...
Compared to the [net.IP](/net#IP) type, \[Addr] type takes less memory, is immutable, and is comparable (supports == and being a map key).
