...
[assembly: go.GoPositionMap("net/hook_windows.go", "hook_windows.cs", "")]
...
internal static Func<int32, int32, int32, ж<syscall.WSAProtocolInfo>, uint32, uint32, (syscallꓸHandle, error)> wsaSocketFunc = windows.WSASocket;
