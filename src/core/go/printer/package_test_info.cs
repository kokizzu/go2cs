...
global using static global::go.go.printer_package;
global using static global::go.go.printer_internal_test_package;
...
using go;
using static global::go.go.printer_test_package;
...
[assembly: global::go.GoPositionMap("go/printer/example_test.go", "example_test.cs", "ABIisoKAgoKAgoLY5riMwqiCgpamgg==")]
// </GoSourcePositionMaps>

namespace go.go;

[GoPackage("printer_test")]
public static partial class printer_test_package
{
    ...
    [GoInit] internal static void initᴛᴛproduction() {
        builtin.initPackage(typeof(global::go.go.printer_package));
    }
}
