...
[![Tests](https://img.shields.io/badge/Tests-169%2F169_validated-brightgreen?logo=go)](https://go2cs.net/validation/1.24.13.3/time.html) [![Docs](https://img.shields.io/badge/Docs-@1.24.13-00ADD8?logo=go)](https://pkg.go.dev/time@go1.24.13)\
[![Source](https://img.shields.io/badge/Source-@1.24.13-00ADD8?logo=go)](https://github.com/golang/go/tree/go1.24.13/src/time) [![Source](https://img.shields.io/badge/Source-@1.24.13.3-512BD4?logo=dotnet)](https://github.com/ritchiecarroll/go2cs/tree/nuget-1.24.13.3/src/core/time)
...
Operating systems provide both a “wall clock,” which is subject to changes for clock synchronization, and a “monotonic clock,” which is not. The general rule is that the wall clock is for telling time and the monotonic clock is for measuring time. Rather than split the API, in this package the Time returned by [time.Now](https://pkg.go.dev/time@go1.24.13#Now) contains both a wall clock reading and a monotonic clock reading; later time-telling operations use the wall clock reading, but later time-measuring operations, specifically comparisons and subtractions, use the monotonic clock reading.
...
Other idioms, such as [time.Since](https://pkg.go.dev/time@go1.24.13#Since)(start), [time.Until](https://pkg.go.dev/time@go1.24.13#Until)(deadline), and time.Now().Before(deadline), are similarly robust against wall clock resets.
...
Because the monotonic clock reading has no meaning outside the current process, the serialized forms generated by t.GobEncode, t.MarshalBinary, t.MarshalJSON, and t.MarshalText omit the monotonic clock reading, and t.Format provides no format for it. Similarly, the constructors [time.Date](https://pkg.go.dev/time@go1.24.13#Date), [time.Parse](https://pkg.go.dev/time@go1.24.13#Parse), [time.ParseInLocation](https://pkg.go.dev/time@go1.24.13#ParseInLocation), and [time.Unix](https://pkg.go.dev/time@go1.24.13#Unix), as well as the unmarshalers t.GobDecode, t.UnmarshalBinary. t.UnmarshalJSON, and t.UnmarshalText always create times with no monotonic clock reading.
