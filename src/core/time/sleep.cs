...
[assembly: go.GoPositionMap("time/sleep.go", "sleep.cs", "AA0cAAUQAAgGgoIAECSuwoKUgqaUAAIUAAgGpgAQRgAVAoKUAAI0ABcCgoKCAAIwABcCgpSCqOwACSAACgKuwqaC")]
...
internal static int64 when(Duration d) {
    if (d <= 0) {
        return runtimeNano();
    }
