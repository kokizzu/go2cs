...
[assembly: go.GoPositionMap("strconv/ftoa_test.go", "ftoa_test.cs", "ABcqgACPAbgCgoKCgoKUgoKUgoKClIKC3IKCgoKCgIK2goKCgILsgoKClIKCgoSCgoKCgpaCgoKCgoLKooKAgrYAMmSCspKC3IKCsqKC")]
...
public static void TestFormatFloatInvalidBitSize(ж<testing.T> Ꮡt) {
    GoFrame ᒐ = default;
    try {
        defer(() => {
            {
