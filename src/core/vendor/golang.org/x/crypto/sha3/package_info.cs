...
using go;
using static go.vendor.golang.org.x.crypto.sha3_package;
...
public static partial class sha3_package
{
    ...
    // <TypeAccessibility>
    internal partial struct cshakeState {}
    internal partial struct spongeDirection {}
    [GoValueClone("a", "storage")] internal partial struct state {}
    public partial interface ShakeHash {}
    // </TypeAccessibility>
}
