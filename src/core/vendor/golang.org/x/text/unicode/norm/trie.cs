...
internal static ж<sparseBlocks> ᏑnfcSparse = new StandardBox<sparseBlocks>(default(sparseBlocks));
...
internal static ж<sparseBlocks> ᏑnfkcSparse = new StandardBox<sparseBlocks>(default(sparseBlocks));
