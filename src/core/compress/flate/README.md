...
[![Tests](https://img.shields.io/badge/Tests-64%2F64_validated-brightgreen?logo=go)](https://go2cs.net/validation/1.23.1.3/compress.flate.html) [![Docs](https://img.shields.io/badge/Docs-@1.23.1-00ADD8?logo=go)](https://pkg.go.dev/compress/flate@go1.23.1)
