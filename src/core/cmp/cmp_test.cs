...
[assembly: go.GoPositionMap("cmp/cmp_test.go", "cmp_test.cs", "AD5yooKClLC0tLS0gsqCgoKUsLS0tLSCyqaCgoKClIIACQqCAAgYgoCCAAkKpoKEgoIACA7CAAgcvoI=")]
...
internal static slice<testsᴛ1> tests = new testsᴛ1[]{
    ...
    new((nint)(1), (nint)(1), 0),
    new((nint)(2), (nint)(1), +1),
    new((@string)"a"u8, (@string)"aa"u8, -1),
    new((@string)"a"u8, (@string)"a"u8, 0),
    new((@string)"aa"u8, (@string)"a"u8, +1),
    new(1.0D, 1.1D, -1),
    new(1.1D, 1.1D, 0),
    new(1.1D, 1.0D, +1),
