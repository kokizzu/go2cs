...
if ($drift) {
    ...
    #                       time -- time joined the list at r43e, having previously landed in the
    #                       "inspect" bucket every sweep with a diff byte-identical in shape to the
    #                       other two, which is exactly the false alarm this section exists to stop).
    #
