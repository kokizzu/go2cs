...
internal static void Main() {
    fmt.Println((@string)"-- named float conversion --");
    var f = ((MyFloat)(/* -math.Sqrt2 */ -1.4142135623730951D));
    fmt.Println(f.Abs());
    fmt.Println((@string)"-- float64 constant expressions (IEEE 754 bits, want-match) --");
    ...
    fmt.Println((@string)"-- float32 constant expressions (IEEE 754 bits, want-match) --");
    ...
    fmt.Println((@string)"-- exact-value identities --");
    fmt.Println((@string)"MaxFloat64 == literal:", (float64)MaxFloat64 == 1.7976931348623157e+308D);
    fmt.Println((@string)"SmallestNonzeroFloat64 == literal:", (float64)SmallestNonzeroFloat64 == 5e-324D);
    fmt.Println((@string)"MaxFloat32 == literal:", (float32)MaxFloat32 == 3.4028235e+38F);
    fmt.Println((@string)"Log10E == literal:", (float64)Log10E == 0.4342944819032518D);
    fmt.Println((@string)"-- IsInf boundary --");
    fmt.Println((@string)"isInf(MaxFloat64):", isInf(1.7976931348623157e+308D, 1));
    fmt.Println((@string)"isInf(-MaxFloat64):", isInf(-1.7976931348623157e+308D, -1));
    fmt.Println((@string)"isInf(truncated 1.79769e+308):", isInf(1.79769e+308D, 1));
    fmt.Println((@string)"truncated < MaxFloat64:", 1.79769e+308D < (float64)MaxFloat64);
}
