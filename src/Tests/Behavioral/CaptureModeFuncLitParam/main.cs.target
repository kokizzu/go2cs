...
internal static void runDeferred(Tally @base) => func((defer, recover) => {
    deferǃ((Tally tʗp) => {
        ...
        Ꮡt.Add(4);
        fmt.Println((@string)"deferred:", t.total, t.log);
    }, @base, defer);
});
...
internal static void Main() {
    ...
    fmt.Println((@string)"assigned:", total, log);
    fmt.Println((@string)"caller copy untouched:", seed.total, seed.log);
    var (total2, log2) = ((Func<Tally, (nint, @string)>)(tʗp => {
        ref var t = ref heap(tʗp, out var Ꮡt);
        Ꮡt.Add(7);
        return (t.total, t.log);
    }))(new Tally(total: 1, log: "i"u8));
    fmt.Println((@string)"iife:", total2, log2);
    var @base = new Tally(total: 2, log: "d"u8);
    runDeferred(@base);
    fmt.Println((@string)"deferred source untouched:", @base.total, @base.log);
    var g = (Tally tʗp) => {
        ref var t = ref heap(tʗp, out var Ꮡt);
        var bump = () => {
            Ꮡt.Add(9);
    ...
    fmt.Println((@string)"nested:", total4, log4);
    ...
    fmt.Println((@string)"variadic:", total5, log5);
}
