...
var staleCoreReferences = []string{
	"archive/tar/archive.tar.tests.csproj -> runtime/internal/math",
	"bytes/bytes.tests.csproj -> runtime/internal/math",
	"cmp/cmp.tests.csproj -> runtime/internal/math",
	"compress/lzw/compress.lzw.tests.csproj -> runtime/internal/math",
	"crypto/ecdh/crypto.ecdh.tests.csproj -> crypto/internal/edwards25519/field",
	"crypto/ecdh/crypto.ecdh.tests.csproj -> crypto/internal/nistec",
	"crypto/ecdsa/crypto.ecdsa.tests.csproj -> crypto/internal/bigmod",
	"crypto/ecdsa/crypto.ecdsa.tests.csproj -> crypto/internal/nistec",
	"crypto/elliptic/crypto.elliptic.tests.csproj -> crypto/internal/nistec",
	"crypto/rsa/crypto.rsa.tests.csproj -> crypto/internal/bigmod",
	"crypto/tls/crypto.tls.tests.csproj -> crypto/internal/mlkem768",
	"crypto/tls/crypto.tls.tests.csproj -> runtime/internal/math",
	"crypto/x509/crypto.x509.tests.csproj -> runtime/internal/math",
	"encoding/asn1/encoding.asn1.tests.csproj -> runtime/internal/math",
	"encoding/base32/encoding.base32.tests.csproj -> runtime/internal/math",
	"encoding/base64/encoding.base64.tests.csproj -> runtime/internal/math",
	"encoding/binary/encoding.binary.tests.csproj -> runtime/internal/math",
	"encoding/gob/encoding.gob.tests.csproj -> runtime/internal/math",
	"encoding/json/encoding.json.tests.csproj -> runtime/internal/math",
	"fmt/fmt.tests.csproj -> runtime/internal/math",
	"go/constant/go.constant.tests.csproj -> runtime/internal/math",
	"hash/maphash/hash.maphash.tests.csproj -> runtime/internal/math",
	"html/template/html.template.tests.csproj -> runtime/internal/math",
	"image/jpeg/image.jpeg.tests.csproj -> runtime/internal/math",
	"internal/fmtsort/internal.fmtsort.tests.csproj -> runtime/internal/math",
	"internal/fuzz/internal.fuzz.tests.csproj -> runtime/internal/math",
	"internal/itoa/internal.itoa.tests.csproj -> runtime/internal/math",
	"internal/reflectlite/internal.reflectlite.tests.csproj -> runtime/internal/math",
	"internal/trace/internal.trace.tests.csproj -> runtime/internal/math",
	"log/slog/log.slog.tests.csproj -> runtime/internal/math",
	"maps/maps.tests.csproj -> runtime/internal/math",
	"math/big/math.big.tests.csproj -> runtime/internal/math",
	"math/cmplx/math.cmplx.tests.csproj -> runtime/internal/math",
	"math/rand/math.rand.tests.csproj -> runtime/internal/math",
	"math/rand/v2/math.rand.v2.tests.csproj -> runtime/internal/math",
	"mime/multipart/mime.multipart.tests.csproj -> runtime/internal/math",
	"net/http/net.http.tests.csproj -> runtime/internal/math",
	"net/netip/net.netip.tests.csproj -> runtime/internal/math",
	"slices/slices.tests.csproj -> runtime/internal/math",
	"sort/sort.tests.csproj -> runtime/internal/math",
	"strconv/strconv.tests.csproj -> runtime/internal/math",
	"strings/strings.tests.csproj -> runtime/internal/math",
