[assembly: go.GoPositionMap("main.go", "main.cs", "AAgagKKAooAACxiCloKEkoSShIaChIKEgoKEgoKGgoqChIKKgoKC")]
...
internal static void Main() {
    ...
    fmt.Println(takeU8((uint8)(((uint8)(~a)))));
    int8 c = 100;
    int8 d = 100;
