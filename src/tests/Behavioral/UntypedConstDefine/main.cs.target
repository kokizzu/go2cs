[assembly: go.GoPositionMap("main.go", "main.cs", "ABQ4goKChIKGgoKCgoIAAhCigoKChIKCjIKCgoKEgoKEgoKEgoKEgoKCjIKCgoSCgoSCgoyCgoKWgtqCgoKCgpQ=")]
...
internal static void tightenGuards() {
    GoFrame ᒐ = default;
    try {
