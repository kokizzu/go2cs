[assembly: go.GoPositionMap("main.go", "main.cs", "AAwggO6CpoKCgoKChIKCAAgYgoKCgqY=")]
...
internal static void Main() {
    ...
    Func<nint, bool> even = (nint n) => n % 2 == 0;
...
public static nint Filter(this Sieve sv, Func<nint, bool> f) {
    nint count = 0;
