...
using go;
using static go.ItabLateRegistration.lib_package;
...
[assembly: go.GoPositionMap("lib.go", "lib.cs", "ABIqgKSA6ICkgAAJDICkgoSClqaChIKW")]
// </GoSourcePositionMaps>
...
public static partial class lib_package
{
    ...
    public partial interface Sized {}
    public partial struct Blank {}
