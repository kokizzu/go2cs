...
public static class Program
{
    ...
    // measured rather than reasoned.  This arm is NOT fixed by either change on this branch and is
    // reported as a known residual.
    // ---------------------------------------------------------------------------------------------
    private struct View
    {
        private Tbl m_value;
        ...
        // The generated by-value conversion operator - the one mpallocbits' `(pageBits)(b)` binds.
    ...
    private static int Arm8_ByValueWholeWrapperBox()
    {
        ...
        ж<Tbl> viaConversion = Ꮡ((Tbl)(b));           // the emitted `Ꮡ((pageBits)(b))`
